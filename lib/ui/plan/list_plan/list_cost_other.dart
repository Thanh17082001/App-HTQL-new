...
class ListCostOther extends StatefulWidget {
  const ListCostOther({super.key});

  @override
  State<ListCostOther> createState() => _ListCompanionState();
}

class _ListCompanionState extends State<ListCostOther> {
  ...
  Widget build(BuildContext context) {
    return Consumer<CostOtherManager>(builder: (context, costOtherManager, idx) {
      costs = costOtherManager.costs;
      return Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          GestureDetector(
            onTap: () async {
              await Navigator.of(context).pushNamed(CostOther.routerName);
            },
            child: Container(
        ...
        AccordionSection(
          ...
          header: Row(
            children: [
              GestureDetector(
                  onTap: () {
                    context.read<CostOtherManager>().deleteAt(cost);
                  },
                  child: const Icon(
                    Icons.close,
                    color: Colors.red,
