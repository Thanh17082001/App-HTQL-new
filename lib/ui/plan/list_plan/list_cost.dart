...
class ListCostPlan extends StatefulWidget {
  const ListCostPlan({super.key});

  @override
  State<ListCostPlan> createState() => _ListCompanionState();
}

class _ListCompanionState extends State<ListCostPlan> {
  ...
  Widget build(BuildContext context) {
    return Consumer<CostPlanManager>(builder: (context, costPlanManager, idx) {
      costs = costPlanManager.costs;
      return Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          GestureDetector(
            onTap: () async {
              await Navigator.of(context).pushNamed(CostPlan.routerName);
            },
            child: Container(
        ...
        AccordionSection(
          ...
          header: Row(
            ...
            children: [
              GestureDetector(
                  onTap: () {
                    context.read<CostPlanManager>().deleteAt(cost);
                  },
                  child: const Icon(
                    Icons.close,
                    color: Colors.red,
