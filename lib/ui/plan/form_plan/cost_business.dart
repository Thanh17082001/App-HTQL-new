...
class CostBusiness extends StatefulWidget {
  static const routerName = '/cost-business';

  const CostBusiness({super.key});

  @override
  State<CostBusiness> createState() => _GeneralInfomationState();
}

class _GeneralInfomationState extends State<CostBusiness> {
  ...
  CostModel data = CostModel(loaiChiPhiID: 2);
  ...
  submit() {
    ...
    context.read<CostBusinessManager>().addCostPlan(data);
    DialogForm.successDialog(context);
    _formKey.currentState!.reset();
     data = CostModel(loaiChiPhiID: 2);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chi phí kinh doanh'),
      ),
